      ...
      <div className="container mx-auto px-4 grid lg:grid-cols-5 gap-6 md:gap-12 items-center transition-all duration-150 ease-in py-16 md:py-20">
        ...
        >
          {/* Content with glass panel */}
            ...
            >
              Specializing in expert tree trimming, palm care, and comprehensive lawn services with over <span className="italic text-green-200 font-medium">24 years of experience</span>. Serving the Rio Grande Valley in Texas.
            </motion.p>
            <motion.div 
