    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-5 transition-all duration-200">
          ...
          <a
            href={switchHref}
            hrefLang={switchLabel === "EN" ? "en" : "es"}
            className="text-xs font-medium text-zinc-600 border border-zinc-200 rounded-md px-2 py-1 hover:text-green-700 hover:border-green-300/80 transition-colors"
          >
            {switchLabel}
          </a>
          <Button
      ...
      >
        <nav className="flex flex-col space-y-3 py-4 px-6">
          ...
          <a
            href={switchHref}
            hrefLang={switchLabel === "EN" ? "en" : "es"}
            className="text-sm font-medium text-zinc-700 hover:text-green-700 py-2 px-3 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-md transition-colors border border-zinc-200"
            onClick={() => setMobileMenuOpen(false)}
          >
            {switchLabel}
          </a>
